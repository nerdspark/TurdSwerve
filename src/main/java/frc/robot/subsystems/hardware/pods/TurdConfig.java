...
public class TurdConfig {
    ...
    public double azimuthRotationsPerTurn;
     ...
     */
    public TurdConfig(int azimuthLimit, double azimuthRotationsPerTurn, boolean azimuthBrake, double azimuthRR, double kP, double kI, double kD, double wildcard, double maxOut, int driveLimit, int boostDriveLimit, boolean driveBrake, double driveRR, double driveSpeedMult, PodType podType) {
        this.azimuthLimit = azimuthLimit;
        this.azimuthRotationsPerTurn = azimuthRotationsPerTurn;
    ...
    public TurdConfig(int absoluteEncoderID, int azimuthID, boolean azimuthInvert, int driveID, boolean driveInvert, double absoluteEncoderOffset, TurdConfig config) {
        this(config.azimuthLimit, config.azimuthRotationsPerTurn, config.azimuthBrake, config.azimuthRR, config.kP, config.kI, config.kD, config.wildcard, config.maxOut, config.driveLimit, config.boostDriveLimit, config.driveBrake, config.driveRR, config.driveSpeedMult, config.podType);        
